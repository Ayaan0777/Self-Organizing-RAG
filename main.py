...
# ══════════════════════════════════════════════════════════════
#  MOVED TO auto_worker.py — Run separately: python auto_worker.py
#  Kept here for reference only. Do NOT uncomment to avoid
...
async def startup():
    ...
    # Auto-repair is handled by auto_worker.py (run separately).
